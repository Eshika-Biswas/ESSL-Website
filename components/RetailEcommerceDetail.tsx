...
// ─── 4 Retail & E-Commerce Clients ──────────────────────────────────────────
interface RetailClient {
  name: string;
  type: string;
  logo: string;
  initials: string;
      ...
      <section className="relative w-full min-h-[520px] sm:min-h-[620px] md:min-h-[700px] lg:min-h-[760px] xl:min-h-[820px] 2xl:min-h-[880px] flex items-center overflow-hidden border-b border-slate-200 bg-[#f8fafc]">
        <div className="absolute inset-0 z-0 w-full h-full">
          <Image
            ...
            fill
            sizes="100vw"
            className="object-cover object-[88%_10%] md:object-top sm:object-[center_top] lg:object-[right_top]"
            priority
          />
        </div>
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-14">
              ...
              <h2
                ...
                style={{ fontFamily: 'var(--font-display)' }}
              >
                Trusted by Premier <span className="text-[rgb(20,109,174)]">Retail & E-Commerce</span> Brands
              </h2>
              <p className="text-slate-500 text-sm sm:text-base mt-2">
                Empowering leading retail chains and consumer brands.
              </p>
            </div>

            {/* 4 Retail Clients Grid - Centered Max Width */}
