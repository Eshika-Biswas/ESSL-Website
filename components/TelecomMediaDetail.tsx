...
const leftSolutions = [
  {
    title: 'Core Network',
    description: 'Carrier-grade IP/MPLS core routing and high-capacity optical backbone infrastructure.',
    icon: Network,
  },
  {
    title: 'Data Center',
    description: 'Hyperscale Tier-III/IV data center facilities built for telco cloud workloads and streaming density.',
    icon: Server,
  },
  {
    title: 'Edge Computing',
    description: 'Ultra-low latency edge compute nodes supporting 5G network slicing and real-time streaming.',
    icon: Cpu,
  },
  {
    title: 'Network Security',
    description: 'Carrier-grade firewalling, subscriber privacy defense, and perimeter isolation architectures.',
    icon: Lock,
  },
  {
    title: 'DDoS Protection',
    description: 'Multi-terabit volumetric DDoS mitigation platforms safeguarding subscriber uptime and routing.',
    icon: ShieldCheck,
  },
];
...
const rightSolutions = [
  {
    ...
    description: 'Intelligent CDN caching, video traffic optimization, and dynamic bandwidth shaping engines.',
    icon: Zap,
  },
  {
    title: 'Monitoring Platform',
    description: 'Real-time NOC telemetries, network performance monitoring (NPM), and synthetic traffic analysis.',
    icon: Eye,
  },
  {
    title: 'Cloud Infrastructure',
    description: 'OpenStack and Kubernetes carrier cloud platforms for Network Function Virtualization (NFV).',
    icon: Cloud,
  },
  {
    title: 'AI Operations',
    description: 'AIOps predictive anomaly detection, self-healing network routines, and automated triage.',
    icon: Activity,
  },
  {
    title: 'Managed Services',
    description: '24/7/365 NOC operations, dispatch field engineering, and SLA-backed network maintenance.',
    icon: Headphones,
  },
];
...
const telecomClients: ClientItem[] = [
  { name: 'Grameenphone', type: 'Mobile Operator', initials: 'GP' },
  { name: 'Robi Axiata', type: 'Mobile Operator', initials: 'ROB' },
  { name: 'Banglalink', type: 'Mobile Operator', initials: 'BLK' },
  { name: 'Teletalk', type: 'State Mobile Operator', initials: 'TLT' },
  { name: 'Summit Communications', type: 'Fiber Infrastructure', initials: 'SCL' },
  { name: 'Fiber@Home', type: 'ITC & Optical Fiber', initials: 'FAH' },
  { name: 'Link3 Technologies', type: 'ISP & Enterprise Tech', initials: 'LNK' },
  { name: 'Carnival Internet', type: 'Broadband ISP', initials: 'CRN' },
  { name: 'Amber IT', type: 'Enterprise ISP', initials: 'AMB' },
  { name: 'BDCOM Online', type: 'ISP & IT Services', initials: 'BDC' },
  { name: 'Dotlines Group', type: 'Telco & Media', initials: 'DLG' },
  { name: 'InfoLink', type: 'ISP & Connectivity', initials: 'INF' },
];

export default function TelecomMediaDetail() {
  const gridBgStyle = {
    ...
    <div className="w-full overflow-hidden bg-slate-50">
      ...
      <section className="relative w-full min-h-[540px] sm:min-h-[600px] flex items-center overflow-hidden py-20 sm:py-28 border-b border-slate-200">
        <div className="absolute inset-0 z-0 w-full h-full">
          <Image
            src="/images/industries/telecom-media.png"
            alt="Telecom & Media Hero Background"
            fill
            sizes="100vw"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-2xl text-left space-y-6">
            ...
            <p className="text-lg sm:text-xl text-slate-700 leading-relaxed max-w-xl font-normal">
              Build high-performance, carrier-grade infrastructure for modern connectivity.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2
              ...
              style={{ fontFamily: 'var(--font-display)' }}
            >
              Carrier-Grade <span className="text-[rgb(20,109,174)]">Telecom & Cloud Infrastructure</span>
            </h2>
            <p className="text-slate-600 text-base sm:text-lg">
              Scalable, resilient connectivity solutions built to handle terabits of mobile data, streaming video, and cloud traffic.
            </p>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-14">
            ...
            <h2
              ...
              style={{ fontFamily: 'var(--font-display)' }}
            >
              Trusted by Top <span className="text-[rgb(20,109,174)]">Telecom & Media</span> Operators
            </h2>
            <p className="text-slate-500 text-sm sm:text-base mt-2">
              Empowering mobile operators, fiber backbone providers, and digital media pioneers.
            </p>
          </div>

          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 sm:gap-5">
            {telecomClients.map((client) => (
              <div
                key={client.name}
      ...
      <section className="relative py-20 bg-gradient-to-br from-[#0f1420] via-[rgb(14,76,122)] to-[#0f1420] text-white overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          <h2
            ...
            style={{ fontFamily: 'var(--font-display)' }}
          >
            Scale Your <span className="text-sky-300">Carrier Network & Cloud</span> Infrastructure
          </h2>
          <p className="text-slate-200 text-base sm:text-lg max-w-2xl mx-auto font-light leading-relaxed">
            Partner with our telco engineering specialists to deploy high-availability core routing, edge computing, and DDoS mitigation platforms.
          </p>
