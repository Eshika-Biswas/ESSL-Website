// TODO: add real careers copy and link to careers page or job listing source
'use client';
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className={`max-w-2xl mx-auto transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 mb-6 font-[family-name:var(--font-display)]">
            [Careers heading placeholder]
          </h2>
          <p className="text-slate-600 text-base leading-relaxed mb-8">
            [Real careers and opportunities description copy goes here. This placeholder section describes our work culture, growth opportunities, and open positions.]
          </p>
