...
export default function AboutMegaMenu({ isOpen, onClose }: AboutMegaMenuProps) {
  return (
    <div
    ...
    >
      <div className="w-[320px] p-5 rounded-2xl border border-white/10 bg-[#0f1420]/95 backdrop-blur-xl shadow-[0_25px_60px_-15px_rgba(0,0,0,0.9)] flex flex-col gap-2">
