...
const capabilities = [
  {
    ...
    description: 'Corporate Website, Customer Portal, HRM, CRM, ERP, Inventory, Asset Management, Ticketing',
    icon: Monitor,
  },
  {
    number: '02',
    title: 'Custom Applications',
    description: 'Procurement Systems, Finance Integration, Mobile Apps, SaaS Development',
    icon: Smartphone,
  },
  {
    number: '03',
    title: 'Systems Integration',
    description: 'API Development, ERP Integration, Microsoft 365 Integration, CRM Integration, WhatsApp Integration',
    icon: Plug,
  },
];
...
// ─── Component ────────────────────────────────────────────────────────────────
export default function SoftwareEngineeringDetail() {
  ...
  return (
    <div className="w-full bg-[#0f1420] text-slate-100 min-h-screen">
      ...
      >
        ...
        {/* NOTE: Swap image for relevant software engineering loop video when asset becomes available */}
        <div className="absolute inset-0 z-0 bg-[#0a0e17]">
          <Image
            src="/images/software-engineering-card.png"
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-[#08101a]/30 via-transparent to-[#08101a]/50 z-[1]" />
        </div>
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7 text-left">
              ...
              >
                ...
                <span className="text-[rgb(20,109,174)]">Engineering</span>
              </h1>
              ...
              <p className={`text-lg sm:text-xl text-slate-350 leading-relaxed mb-10 max-w-xl transition-all duration-700 delay-200 ${heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
                Custom software solutions and seamless integrations built for your business.
              </p>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`text-center mb-20 transition-all duration-700 ${gridVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <p className="text-slate-500 text-lg max-w-2xl mx-auto">
              Our software engineering capabilities span every critical domain — ensuring nothing is missed.
            </p>
          </div>
      ...
      <section className="relative w-full py-28 sm:py-36 overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-white/70 text-lg sm:text-xl leading-relaxed mb-10 max-w-xl mx-auto">
            Start with a structured consultation. Understand your requirements. Build a roadmap grounded in operational reality.
          </p>
          <Link
            href="/contact"
