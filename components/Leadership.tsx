...
const operationalTeam: OperationalMember[] = [
  ...
  {
    id: 12,
    name: 'Mushfiqur Rahman Kaoushik',
  ...
  },
  {
    ...
    department: 'Network & Security',
    email: 'jahid@ensure-bd.com',
    photo: '/team/jahid.jpeg',
  },
  {
    id: 15,
    name: 'Sultan Mahmud Pial',
