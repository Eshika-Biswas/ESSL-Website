...
const leftSolutions = [
  {
    ...
    description: 'Secure SD-WAN and redundant cellular connectivity across remote field offices and program hubs.',
    icon: Network,
  },
  {
    title: 'Secure Remote Access',
    description: 'Encrypted VPN and Zero Trust identity verification for mobile field workers and relief teams.',
    icon: Lock,
  },
  {
    title: 'Cloud Collaboration',
    description: 'Unified cloud productivity systems enabling seamless coordination across multi-country mission projects.',
    icon: Cloud,
  },
  {
    title: 'Data Protection',
    description: 'Strict encryption standards safeguarding sensitive donor records, research, and beneficiary data.',
    icon: HardDrive,
  },
  {
    title: 'Backup Solutions',
    description: 'Automated offsite data backup protecting mission files from unexpected power or network outages.',
    icon: RefreshCw,
  },
];
...
const rightSolutions = [
  {
    ...
    description: 'Next-gen anti-malware, device encryption, and centralized endpoint management across laptop fleets.',
    icon: ShieldCheck,
  },
  {
    title: 'Managed Services',
    description: 'Cost-effective 24/7 IT infrastructure monitoring, helpdesk support, and remote IT assistance.',
    icon: Headphones,
  },
  {
    title: 'Disaster Recovery',
    description: 'Resilient failover systems ensuring continuous IT operations during emergency response deployments.',
    icon: Server,
  },
  {
    title: 'Microsoft 365',
    description: 'Nonprofit license optimization, secure Exchange cloud mail, SharePoint, and Teams deployment.',
    icon: Monitor,
  },
  {
    title: 'IT Consulting',
    description: 'Strategic IT roadmapping, security audits, and technology cost optimization for non-profits.',
    icon: FileText,
  },
];
...
const ngoClients: ClientItem[] = [
  ...
  { name: 'Transparency Intl BD', type: 'Civil Society NGO', initials: 'TIB' },
  { name: 'BURO Bangladesh', type: 'Microfinance & Dev', initials: 'BUR' },
  { name: 'World Vision Bangladesh', type: 'Child Rights NGO', initials: 'WVB' },
  { name: 'BRAC', type: 'Global Development', initials: 'BRC' },
  { name: 'icddr,b', type: 'Global Health Research', initials: 'ICD' },
  { name: 'CARE Bangladesh', type: 'Humanitarian NGO', initials: 'CAR' },
  { name: 'ActionAid Bangladesh', type: 'Development NGO', initials: 'AAB' },
  { name: 'Save the Children', type: 'Humanitarian Org', initials: 'STC' },
  { name: 'Oxfam in Bangladesh', type: 'Humanitarian Org', initials: 'OXF' },
  { name: 'Plan International', type: 'Development NGO', initials: 'PIB' },
  { name: 'WaterAid Bangladesh', type: 'WASH NGO', initials: 'WAB' },
];
    ...
    <div className="w-full overflow-hidden bg-slate-50">
      ...
      <section className="relative w-full min-h-[560px] sm:min-h-[640px] md:min-h-[700px] lg:min-h-[760px] xl:min-h-[820px] 2xl:min-h-[880px] flex items-center overflow-hidden py-20 sm:py-28 lg:py-32 border-b border-slate-200">
        <div className="absolute inset-0 z-0 w-full h-full">
          <Image
            src="/images/industries/ngos-development.png"
            alt="NGOs & Development Hero Background"
            fill
            sizes="100vw"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-2xl text-left space-y-6">
            ...
            <p className="text-lg sm:text-xl text-slate-700 leading-relaxed max-w-xl font-normal">
              Reliable, secure, and cost-effective technology for mission-driven organizations.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2
              ...
              style={{ fontFamily: 'var(--font-display)' }}
            >
              Mission-Critical <span className="text-[rgb(20,109,174)]">IT Infrastructure & Connectivity</span>
            </h2>
            <p className="text-slate-600 text-base sm:text-lg">
              Empowering NGOs, international development partners, and civil society with secure, cost-optimized technology solutions.
            </p>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-14">
            ...
            <h2
              ...
              style={{ fontFamily: 'var(--font-display)' }}
            >
              Trusted by Premier <span className="text-[rgb(20,109,174)]">NGOs & Development Partners</span>
            </h2>
            <p className="text-slate-500 text-sm sm:text-base mt-2">
              Empowering mission-driven humanitarian organizations, international bodies, and non-profits.
            </p>
          </div>
      ...
      <section className="relative py-20 bg-gradient-to-br from-[#0f1420] via-[rgb(14,76,122)] to-[#0f1420] text-white overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          <h2
            ...
            style={{ fontFamily: 'var(--font-display)' }}
          >
            Empower Your <span className="text-sky-300">Development Mission</span> with IT
          </h2>
          <p className="text-slate-200 text-base sm:text-lg max-w-2xl mx-auto font-light leading-relaxed">
            Partner with ESSL to deploy cost-effective, secure, and reliable technology systems for your humanitarian and development projects.
          </p>
